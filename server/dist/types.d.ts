...
export type MessageType = 'JOIN_ROOM' | 'LEAVE_ROOM' | 'PAIR_DEVICE' | 'PUBLISH_SOURCE' | 'UNPUBLISH_SOURCE' | 'SUBSCRIBE_SOURCE' | 'UNSUBSCRIBE_SOURCE' | 'BROADCAST_SOURCE' | 'UNBROADCAST_SOURCE' | 'SUBSCRIBE_BROADCAST' | 'UNSUBSCRIBE_BROADCAST' | 'OFFER' | 'ANSWER' | 'ICE_CANDIDATE' | 'ICE_RESTART' | 'RENEGOTIATE' | 'SET_CONFIG' | 'GET_CONFIG' | 'HEARTBEAT' | 'REQUEST_TALK' | 'STOP_TALK' | 'WELCOME' | 'ERROR' | 'SOURCE_ADDED' | 'SOURCE_REMOVED' | 'SUBSCRIBER_JOINED' | 'SUBSCRIBER_LEFT' | 'CONFIG_UPDATED' | 'CONFIG_RESULT' | 'DEVICE_STATUS' | 'ROOM_STATE' | 'TALK_ENABLED' | 'TALK_DISABLED' | 'CAPABILITIES' | 'AUDIO_PEAK' | 'REMOVE_DEVICE' | 'DEVICE_REMOVED' | 'DOORBELL' | 'CALL_STATE' | 'SET_DISPLAY_CONFIG' | 'DISPLAY_CONFIG_APPLIED' | 'PRIMARY_BASE_CHANGED';
